...
class ObjectMainDetection {
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/score1.jpg"));
            modelImage2 = ImageUtilities.readMBF(new File("data/noscore1.jpg"));
            modelImage3 = ImageUtilities.readMBF(new File("data/shotting1.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
